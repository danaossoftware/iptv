    ...
    $.ajax({
        ...
        success: function (a) {
            ...
            for (var i = 0; i < categories.length; i++) {
                ...
                $("#channels").append("<div id='category-panel-" + i + "' style='display: none; flex-flow: column nowrap; justify-content: center; align-items: flex-start; align-content: flex-start; width: 100%; height: 100%; position: absolute; left: 0; top: 0; overflow: scroll; overflow-x: hidden; overflow-y: hidden;'></div>")
