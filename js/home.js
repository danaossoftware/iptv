    ...
    $.ajax({
        ...
        success: function (a) {
            ...
            for (var i = 0; i < categories.length; i++) {
                ...
                $("#channels").append("<div id='category-panel-" + i + "' style='overflow-x: scroll; display: none; flex-flow: column wrap; justify-content: flex-start; align-items: center; align-content: center; width: 100%; height: 100%; position: absolute; left: 0; top: 0;'></div>")
